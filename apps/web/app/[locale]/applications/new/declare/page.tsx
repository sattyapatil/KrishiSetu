...
import { ApplicationDeclareView } from '../../../../../src/features/applications/ApplicationDeclareView.js';
import { AccessRequiredView } from '../../../../../src/components/AccessRequiredView.js';
import { useJourney } from '../../../../../src/features/journey/index.js';

export default function ApplicationDeclarePage({
  params,
}: {
  ...
  return <ApplicationDeclareView locale={locale} />;
}
